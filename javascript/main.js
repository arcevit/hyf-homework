...
let renderquestion=document.querySelector('.question-box')
...
class Quiz{
    ...
    //render questions
         for (let i = 0; i < questions.length; i++) {
            ...
            renderquestion.appendChild(questioncontainer)  
    ...
    function next(){
        ...
        if(n>1){     
            ...
            quiz.getScore()
             ...
             renderquestion.children[n].style.opacity='0';
             renderquestion.children[n+1].style.transform="scale(1)";
             renderquestion.children[n+1].style.opacity="1";
